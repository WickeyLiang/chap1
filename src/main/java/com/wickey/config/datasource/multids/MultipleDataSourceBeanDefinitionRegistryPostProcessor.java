package com.wickey.config.datasource.multids;
 ...
 * Created by fatboyliang on 2016/10/3.
 */
...
public class MultipleDataSourceBeanDefinitionRegistryPostProcessor implements BeanDefinitionRegistryPostProcessor,EnvironmentAware{
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        //设置为主数据源;
        //如果没使用druid，默认主数据源就是dataSource，这里druidDataSource对应DruidConfiguration.java里面的
        //druidDataSource对象
        beanFactory.getBeanDefinition("druidDataSource").setPrimary(true);
